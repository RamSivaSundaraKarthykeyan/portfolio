...
const projects = [
  {
    ...
    description: "Full-stack finance tracker with real-time data aggregation, vitualization, and cloud sync.",
    tags: ["Next.js", "JavaScript", "Google Auth", "MongoDB"],
    image: "/finance-tracker.png",
    github: "https://github.com/RamSivaSundaraKarthykeyan/finance-tracker-the-actual",
    live: "https://finance-tracker-navy-five.vercel.app/",
    featured: true,
  },
  {
    id: 2,
    title: "Startup Backers",
    description: "A frontend project with modern UI design for a startup hub.",
    tags: ["Next.js", "JavaScript", "Tailwind CSS", "Framer Motion"],
    image: "/startup-backers.png",
    github: "https://github.com/RamSivaSundaraKarthykeyan/StarterBackup-Frontend-Nextjs",
    live: "https://starter-backup-frontend-nextjs.vercel.app/",
    featured: true,
  },
  {
    id: 3,
    title: "Clicker",
    description: "A game about clicking created entirely with Godot Engine.",
    tags: ["Godot", "GDScript", "Krita"],
    image: "/clicker.png",
    github: "https://github.com/RamSivaSundaraKarthykeyan/Clicker",
    live: "https://ramsivasundarakarthykeyan.itch.io/just-a-clicker",
    featured: true,
  },
  //{
   // id: 4,
    //title: "Task Cards",
    //description: "A modern task manager that allows users to assign tasks in a task like UI.",
